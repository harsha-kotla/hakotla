      ...
      <main className="mx-auto max-w-3xl px-6 py-16 sm:px-8 sm:py-24">
        <div className="space-y-6">
          ...
          <p className="text-lg text-black">
            This is where I'll share some of my thoughts and updates. Check <Link href="https://wordmate.app/blog" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 transition-colors">WordMate's blog</Link> for more.
          </p>
        </div>
      </main>
    </div>
